...
<p className="text-2xl md:text-3xl font-semibold text-primary tracking-wide text-center">
  <span className="block md:inline italic">Confidence in Growth</span>
  <span className="hidden md:inline">, </span>
  <span className="block md:inline">Clarity in Capital</span>
</p>
